...
import loadingAnimationUrl from '../../assets/sendingpayment.gif'; // ใช้ import สำหรับไฟล์ GIF

const LoadingPaymentSending = () => {
    return (
...
export default LoadingPaymentSending;
