...
const styles = {
    container: {
        ...
        alignItems: 'center',
        height: '30px',  // ให้เต็มความสูงของ viewport
        width: '100px',   // ให้เต็มความกว้างของ viewport
        textAlign: 'center',
        backgroundColor: '#fffff', // สีพื้นหลังเป็นเทาอ่อน
    },
    image: {
        width: '150px', // ขนาดภาพ
...
export default LoadingAddtoCart;
